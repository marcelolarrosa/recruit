...
@section('main-content')
        ...
        <form action="{{route('candidate-save', $candidate->id)}}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary"> 
                        @if($candidate->portfolio_link != null)
                          <input type="text" name="portfolio_link" class="form-control" id="porfolio" placeholder="Portfolio url" value="{{$candidate->portfolio_link}}">
                        @else
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">
                        @if($candidate->github_link != null)
                            <input type="text" name="github_link" class="form-control" id="github" placeholder="Github url" value="{{$candidate->github_link}}">
                        @else
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">
                      @if($candidate->twitter_link != null)
                      <input type="text" name="twitter_link" class="form-control" id="twitter" placeholder="Twitter url" value="{{$candidate->twitter_link}}">
                      @else
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-secondary">
                      @if($candidate->behance_link != null)
                      <input type="text" name="behance_link" class="form-control" id="behance" placeholder="Behance url" value="{{$candidate->behance_link}}">
                      @else
              ...
              <div class="card mb-3">
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" name="fullname" class="form-control" id="fullName" placeholder="Enter full name" value="{{$candidate->fullname}}">
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" name="position" class="form-control" id="position" placeholder="Position" value="{{$candidate->position}}">
                  </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="email" name="email" class="form-control" id="email" placeholder="Email" value="{{$candidate->email}}">
                  </div>
                </div>
                <hr>
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" name="phone" class="form-control" id="phone" placeholder="Phone" value="{{$candidate->phone}}">
                  </div>
                </div>
                <hr>
                <div class="row">
                  ...
                  <div class="col-sm-9 text-secondary">
                    <input type="text" name="address" class="form-control" id="address" placeholder="Address" value="{{$candidate->address}}">
                  </div>
                </div>
                <hr>
                <div class="row">
                   ...
                   <div class="form-group">
                    <label for="exampleFormControlTextarea1"><strong> Notes on this candidate: </strong></label>
                        @if($candidate->notes != null)
                            <textarea name="notes" class="form-control rounded-0" id="exampleFormControlTextarea1" rows="7" cols="40">{{$candidate->notes}}</textarea>
                        @else
                      ...
                      <div class="modal-dialog modal-confirm">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer justify-content-center">
                            ...
                            <a href="{{route('candidate-delete', $candidate->id)}}" type="button" class="btn btn-danger"> Delete </a>
                          </div>
                        </div>
                      </div>
                    </div>
